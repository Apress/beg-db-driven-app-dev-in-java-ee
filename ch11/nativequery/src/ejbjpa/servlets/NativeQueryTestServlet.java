...
import ejbjpa.ejb.*;
public class NativeQueryTestServlet extends HttpServlet {
    @EJB private NativeQueryTest nativeQueryTest;
    public void doGet(
        ...
        try{
           List<Employee> employees = nativeQueryTest.getEmployees();
